...
public class WebServiceRequest {
    ...
    public Object request(String url, String method, Map<String, Object> data, String contentType) throws FaceServiceException {
        ...
        throw new FaceServiceException("Error! Incorrect method provided: " + method);
    }

    private Object get(String url) throws FaceServiceException {
        ...
        try {
            ...
            throw new FaceServiceException(e.getMessage());
        }
    }

    private Object post(String url, Map<String, Object> data, String contentType) throws FaceServiceException {
        return webInvoke("POST", url, data, contentType);
    }

    private Object patch(String url, Map<String, Object> data, String contentType) throws FaceServiceException {
        return webInvoke("PATCH", url, data, contentType);
    }

    private Object webInvoke(String method, String url, Map<String, Object> data, String contentType) throws FaceServiceException {
    ...
    private Object put(String url, Map<String, Object> data) throws FaceServiceException {
    ...
    private Object delete(String url, Map<String, Object> data) throws FaceServiceException {
        try {
